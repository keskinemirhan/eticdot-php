...
<form enctype="multipart/form-data" method="post" class="mx-auto" action="admin-product-update.php">
    ...
    <div class="mb-3">
        ...
        <input class="form-control" type="text" value="<?php echo $product[7] ?>" name="desc" id="desc">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <select class="form-control" name="vendorId" id="vendorId">
            <?php while ($vendor = $vendors->fetch_row()) { ?>
                ...
                <option <?php if ($vendor[0] == $product[3]) echo "selected" ?> value="<?php echo $vendor[0] ?>">
                    <?php echo $vendor[1] ?>
                </option>
            <?php } ?>
...
<form class="mx-auto mt-2" action="admin-product-update.php" method="post">
    <input type="text" name="id" hidden value="<?php echo $product[0] ?>" id="">
